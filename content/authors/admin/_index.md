...
role: Ph.D. of Computer Engineering Student at the University of Virginia
...
bio: Machine Learning Researchers on the Artificial Intelligence for Human Healthcare

# Interests to show in About widget
interests:
  - Artificial Intelligence
  - Machine Learning for Healthcare
  - Multi-modal Probablistic ML
  - Internet of Things

# Education to show in About widget
education:
  courses:
    - course: Doctor of Philosophy, Computer Engineering
      institution: University of Virginia, School of Engineering and Applied Science
      year: 2024
    - course: Master of Science, Computer Science
      institution: Duke University, Graduate School
      year: 2022
...
social:
  - icon: envelope
    icon_pack: fas
    link: 'mailto:hollen.zhang@outlook.com'
  # - icon: twitter
  #   icon_pack: fab
  ...
  - icon: github
    icon_pack: fab
    link: https://github.com/Hollen0318?tab=repositories
  - icon: linkedin
    icon_pack: fab
...
Hi I am Hollen (Haoran) Zhang, current PhD student at <a href='https://duke.edu/'>Duke Univeristy</a>, majored in Computer Science. My research interest includes Artificial Intelligence, especially on its application for real-world impacts. My conviction is that technology should be leveraged to enhance lives and address societal challenges. <a href="https://drive.google.com/uc?id=1UK7QFH24ziLXcvhJgcB3XoD3_RnEMKev&export=download">My CV</a>.
